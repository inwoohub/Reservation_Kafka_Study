...
CRUD 구현보다 **Kafka 이벤트 기반 처리**, **Redis 재고 차감**, **MySQL 원본 재고 반영**, **Consumer 병목 분석**을 경험하는 데 초점을 두었습니다.
...
- MySQL에 저장된 원본 상품 재고와 Redis 재고 간 정합성 보완
- k6 부하 테스트를 통한 병목 분석
...
<img width="1200" alt="3차 최종" src="https://github.com/user-attachments/assets/2fdf1e12-b361-4c5f-be24-08c12193100c" />
...
### 2. Querydsl 벌크 UPDATE SET 절 순서로 인한 상태 변경 오류
